...
import com.intensio.beans.Attributes;
import com.intensio.beans.Languages;
import com.intensio.beans.Movie;
import jakarta.servlet.ServletException;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpSession;
import com.intensio.beans.*;
import com.intensio.beans.dto.ReviewDTO;
import com.intensio.beans.security.PersonDetails;
import com.intensio.service.MovieService;
...
import static com.intensio.beans.Attributes.RETURN_PAGE;
...
public class MainController {
    ...
    public String changeLang(HttpServletRequest request){
        ...
        return "redirect:" + session.getAttribute(RETURN_PAGE) + "?lang="+session.getAttribute(Attributes.LANG_NAME_ATTRIBUTE);
    }
